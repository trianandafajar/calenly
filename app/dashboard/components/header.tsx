...
export default function Header() {
    ...
    return (
        <>
                            ...
                            <ul className="navbar-nav header-right">
                                ...
                                <li className="nav-item dropdown  header-profile">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-end">
                                        ...
                                        <span data-bs-toggle="modal" data-bs-target="#modalLogout" className="dropdown-item ai-icon">
            ...
            <div className="modal fade" id="modalLogout" tabIndex={-1} aria-hidden="true">
